...
- First, we see the same description of the unit cell and space group that we studied above. However, we can find something that is different: 
    ...
    It tells us that the transformation from the DFT cell to the conventional setting is given by:

    $$
    (\boldsymbol{a}_1, \boldsymbol{a}_2, \boldsymbol{a}_3)_{conventional} = 
    (\boldsymbol{a}_1, \boldsymbol{a}_2, \boldsymbol{a}_3)_{DFT}
    \begin{pmatrix}
        1 & 0 & 1 \\ -1 & 1 & 1 \\ 0 & -1 & 1
    \end{pmatrix}
    $$
...
On the other hand, the $\mathbb{Z}_4$ number is:
