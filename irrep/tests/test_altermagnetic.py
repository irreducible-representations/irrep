...
def test_find_altermagnetic_symmetry():
    ...
    assert symop.inversion == False, f"Expected inversion=False, got {symop.inversion}"
    assert symop.time_reversal == False, f"Expected timereversal=False, got {symop.timereversal}"
