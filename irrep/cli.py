...
@click.option(
    ...
    type=str,
    default="+groupinfo",
    help='Filename of the file +groupinfo generated by FPLO'
)
@click.option(
    "-fREP",
    type=str,
    default="+groupreps",
    help='Filename of the file +groupreps generated by FPLO'
)
@click.option(
    "-prefix",
    type=str,
...
@click.option(
    "-code",
    type=click.Choice(["vasp", "abinit", "espresso", "wannier90", "gpaw", "fplo"]),
    default="vasp",
